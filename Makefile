...
oracle-test: ## Test Oracle connection
	$(POETRY) run python -c "from flext_tap_oracle.client import test_connection; test_connection()"
...
clean: ## Clean build artifacts
	rm -rf build/ dist/ *.egg-info/ .pytest_cache/ htmlcov/ .coverage .mypy_cache/ .ruff_cache/ $(TAP_CATALOG) $(TAP_STATE)
...
diagnose: ## Project diagnostics
	...
	@echo "Singer SDK: $$($(POETRY) run python -c 'import singer_sdk; print(singer_sdk.__version__)')"
	@$(POETRY) env info
