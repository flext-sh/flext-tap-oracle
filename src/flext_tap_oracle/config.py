...
class TapOracleConfig(BaseModel):
    ...
    exclude_tables: list[str] | None = Field(None, description="List of tables to exclude")
    replication_method: str = Field(default="FULL_TABLE", description="Replication method")
