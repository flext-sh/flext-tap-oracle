    ...
    class TapOracle(FlextTapOracleUtilitiesClientMixin):
        ...
        def test_oracle_connectivity(
            ...
            try:
                ...
                return r[t.JsonValue].ok(connectivity_result)
            except c.Meltano.SINGER_SAFE_EXCEPTIONS as e:
                return r[t.JsonValue].fail(
        ...
        def validate_oracle_config(
            ...
            try:
                ...
                return r[t.JsonValue].ok(validated_config)
            except c.Meltano.SINGER_SAFE_EXCEPTIONS as e:
                return r[t.JsonValue].fail(
        ...
        def calculate_extraction_metrics(
            ...
            try:
                ...
                performance_rating: str = (
                    "excellent"
                    if records_per_second > c.TapOracle.EXCELLENT_PERFORMANCE_THRESHOLD
                    else "good"
                    if records_per_second > c.TapOracle.GOOD_PERFORMANCE_THRESHOLD
                    else "moderate"
                    if records_per_second > c.TapOracle.MODERATE_PERFORMANCE_THRESHOLD
                    else "slow"
                )
                ...
                return r[t.JsonValue].ok(metrics)
            except c.Meltano.SINGER_SAFE_EXCEPTIONS as e:
                return r[t.JsonValue].fail(
