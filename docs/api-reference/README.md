...
- Primary facades: `FlextTapOracleCli`, `FlextTapOracleConstants`, `FlextTapOracleDiscoverCommand`, `FlextTapOracleModels`, `FlextTapOracleProtocols`, `FlextTapOracleService` (+4 more)
