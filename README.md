...
- Primary facades: `FlextTapOracleCli`, `FlextTapOracleUtilitiesClientMixin`, `FlextTapOracleModels`, `FlextTapOracleStreams`, `FlextTapOracleUtilities`, `FlextTapOracleProtocols` (+6 more)
...
2. Confirm parent MRO chain via `pyproject.toml` `dependencies` filtered by `flext-*` (excluding `flext-tap-oracle` self).
...
- Public extensions exposed by this project: `FlextTapOracleCli`, `FlextTapOracleUtilitiesClientMixin`, `FlextTapOracleModels`, `FlextTapOracleStreams`, `FlextTapOracleUtilities`, `FlextTapOracleProtocols` (+6 more).
